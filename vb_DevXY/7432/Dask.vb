...
Module DASK
    ...
    'Trigger Polarity
    Public Const P9221_AI_TrgPositive As Short = &H0S
    ...
    'Counter Mode
    Public Const SimpleGatedEventCNT As Short = &H1S
    Public Const SinglePeriodMSR As Short = &H2S
    Public Const SinglePulseWidthMSR As Short = &H3S
    Public Const SingleGatedPulseGen As Short = &H4S
    Public Const SingleTrigPulseGen As Short = &H5S
    Public Const RetrigSinglePulseGen As Short = &H6S
    Public Const SingleTrigContPulseGen As Short = &H7S
    Public Const ContGatedPulseGen As Short = &H8S
    Public Const EdgeSeparationMSR As Short = &H9S
    Public Const SingleTrigContPulseGenPWM As Short = &HAS
    Public Const ContGatedPulseGenPWM As Short = &HBS
    Public Const CW_CCW_Encoder As Short = &HCS
    Public Const x1_AB_Phase_Encoder As Short = &HDS
    Public Const x2_AB_Phase_Encoder As Short = &HES
    Public Const x4_AB_Phase_Encoder As Short = &HFS
    Public Const Phase_Z As Short = &H10S
    'GPTC clock source
    Public Const GPTC_CLK_SRC_Ext As Short = &H1S
    Public Const GPTC_CLK_SRC_Int As Short = &H0S
    Public Const GPTC_GATE_SRC_Ext As Short = &H2S
    Public Const GPTC_GATE_SRC_Int As Short = &H0S
    Public Const GPTC_UPDOWN_Ext As Short = &H4S
    Public Const GPTC_UPDOWN_Int As Short = &H0S
    'GPTC clock polarity
    Public Const GPTC_CLKSRC_LACTIVE As Short = &H1S
    Public Const GPTC_CLKSRC_HACTIVE As Short = &H0S
    ...
    Public Const IntGate As Short = &H0S
    Public Const IntUpDnCTR As Short = &H1S
    Public Const IntENABLE As Short = &H2S
    Public Const GPTC_EZ0_ClearPhase0 As Short = &H0S
    Public Const GPTC_EZ0_ClearPhase1 As Short = &H1S
    Public Const GPTC_EZ0_ClearPhase2 As Short = &H2S
    Public Const GPTC_EZ0_ClearPhase3 As Short = &H3S
    Public Const GPTC_EZ0_ClearMode0 As Short = &H0S
    Public Const GPTC_EZ0_ClearMode1 As Short = &H1S
    Public Const GPTC_EZ0_ClearMode2 As Short = &H2S
    Public Const GPTC_EZ0_ClearMode3 As Short = &H3S
    'Watchdog Timer
    'Counter action
    ...
    Public Const P9524_VEX_Range_2R5V As Short = &H0S
    Public Const P9524_VEX_Range_10V As Short = &H1S
    Public Const P9524_VEX_Sence_Local As Short = &H0S
    Public Const P9524_VEX_Sence_Remote As Short = &H2S
    Public Const P9524_AI_AZMode As Short = &H4S
    Public Const P9524_AI_BufAutoReset As Short = &H8S
    ...
    'DA trigger constant
    Public Const P6202_DA_TRGSRC_SOFT As Short = &H0S
    Public Const P6202_DA_TRGSRC_AFI0 As Short = &H1S
    Public Const P6202_DA_TRSRC_SSI As Short = &H2S
    Public Const P6202_DA_TRGSRC_AFI1 As Short = &H3S
    Public Const P6202_DA_TRGMOD_POST As Short = &H0S
    Public Const P6202_DA_TRGMOD_DELAY As Short = &H4S
    Public Const P6202_DA_ReTrigEn As Short = &H20S
    Public Const P6202_DA_DLY2En As Short = &H100S
    'SSI signal code
    Public Const P6202_SSI_DA_CONV As Short = &H4S
    Public Const P6202_SSI_DA_TRIG As Short = &H40S
    'Encoder constant
    Public Const P6202_EVT_TYPE_EPT0 As Short = &H0S
    Public Const P6202_EVT_TYPE_EPT1 As Short = &H1S
    Public Const P6202_EVT_TYPE_EPT2 As Short = &H2S
    Public Const P6202_EVT_TYPE_EZC0 As Short = &H3S
    Public Const P6202_EVT_TYPE_EZC1 As Short = &H4S
    Public Const P6202_EVT_TYPE_EZC2 As Short = &H5S
    Public Const P6202_EVT_MOD_EPT As Short = &H0S
    Public Const P6202_EPT_PULWIDTH_200us As Short = &H0S
    Public Const P6202_EPT_PULWIDTH_2ms As Short = &H1S
    Public Const P6202_EPT_PULWIDTH_20ms As Short = &H2S
    Public Const P6202_EPT_PULWIDTH_200ms As Short = &H3S
    Public Const P6202_EPT_TRGOUT_CALLBACK As Short = &H4S
    Public Const P6202_EPT_TRGOUT_AFI As Short = &H8S
    Public Const P6202_ENCODER0_LDATA As Short = &H5S
    Public Const P6202_ENCODER1_LDATA As Short = &H6S
    Public Const P6202_ENCODER2_LDATA As Short = &H7S
    '------------------------'
    ' Constants for PCI-922x '
    '------------------------'
    ' -- AI Constants -- '
    'Input Type
    Public Const P922x_AI_SingEnded As Short = &H0S
    Public Const P922x_AI_NonRef_SingEnded As Short = &H1S
    Public Const P922x_AI_Differential As Short = &H2S
    'Conversion Source
    Public Const P922x_AI_CONVSRC_INT As Short = &H0S
    ...
    'Trigger Mode
    Public Const P922x_AI_TRGMOD_POST As Short = &H0S
    Public Const P922x_AI_TRGMOD_GATED As Short = &H1S
    'Trigger Source
    Public Const P922x_AI_TRGSRC_SOFT As Short = &H0S
    ...
    'Trigger Polarity
    Public Const P922x_AI_TrgPositive As Short = &H0S
    Public Const P922x_AI_TrgNegative As Short = &H100S
    'ReTrigger
    Public Const P922x_AI_EnReTigger As Short = &H200S
    ' -- AO Constants -- '
    'Conversion Source
    Public Const P922x_AO_CONVSRC_INT As Short = &H0S
    Public Const P922x_AO_CONVSRC_GPI0 As Short = &H1S
    Public Const P922x_AO_CONVSRC_GPI1 As Short = &H2S
    Public Const P922x_AO_CONVSRC_GPI2 As Short = &H3S
    Public Const P922x_AO_CONVSRC_GPI3 As Short = &H4S
    Public Const P922x_AO_CONVSRC_GPI4 As Short = &H5S
    Public Const P922x_AO_CONVSRC_GPI5 As Short = &H6S
    Public Const P922x_AO_CONVSRC_GPI6 As Short = &H7S
    Public Const P922x_AO_CONVSRC_GPI7 As Short = &H8S
    Public Const P922x_AO_CONVSRC_SSI2 As Short = &H9S
    Public Const P922x_AO_CONVSRC_SSI As Short = &H9S
    'Trigger Mode
    Public Const P922x_AO_TRGMOD_POST As Short = &H0S
    Public Const P922x_AO_TRGMOD_DELAY As Short = &H1S
    'Trigger Source
    Public Const P922x_AO_TRGSRC_SOFT As Short = &H0S
    ...
    'Trigger Polarity
    Public Const P922x_AO_TrgPositive As Short = &H0S
    ...
    ' -- DI Constants -- '
    'Conversion Source
    Public Const P922x_DI_CONVSRC_INT As Short = &H0S
    Public Const P922x_DI_CONVSRC_GPI0 As Short = &H1S
    Public Const P922x_DI_CONVSRC_GPI1 As Short = &H2S
    Public Const P922x_DI_CONVSRC_GPI2 As Short = &H3S
    Public Const P922x_DI_CONVSRC_GPI3 As Short = &H4S
    Public Const P922x_DI_CONVSRC_GPI4 As Short = &H5S
    Public Const P922x_DI_CONVSRC_GPI5 As Short = &H6S
    Public Const P922x_DI_CONVSRC_GPI6 As Short = &H7S
    Public Const P922x_DI_CONVSRC_GPI7 As Short = &H8S
    Public Const P922x_DI_CONVSRC_ADCONV As Short = &H9S
    Public Const P922x_DI_CONVSRC_DACONV As Short = &HAS
    'Trigger Mode
    Public Const P922x_DI_TRGMOD_POST As Short = &H0S
    'Trigger Source
    Public Const P922x_DI_TRGSRC_SOFT As Short = &H0S
    ...
    'Trigger Polarity
    Public Const P922x_DI_TrgPositive As Short = &H0S
    Public Const P922x_DI_TrgNegative As Short = &H100S
    'ReTrigger
    Public Const P922x_DI_EnReTigger As Short = &H200S
    ' -- DO Constants -- '
    'Conversion Source
    Public Const P922x_DO_CONVSRC_INT As Short = &H0S
    Public Const P922x_DO_CONVSRC_GPI0 As Short = &H1S
    Public Const P922x_DO_CONVSRC_GPI1 As Short = &H2S
    Public Const P922x_DO_CONVSRC_GPI2 As Short = &H3S
    Public Const P922x_DO_CONVSRC_GPI3 As Short = &H4S
    Public Const P922x_DO_CONVSRC_GPI4 As Short = &H5S
    Public Const P922x_DO_CONVSRC_GPI5 As Short = &H6S
    Public Const P922x_DO_CONVSRC_GPI6 As Short = &H7S
    Public Const P922x_DO_CONVSRC_GPI7 As Short = &H8S
    Public Const P922x_DO_CONVSRC_ADCONV As Short = &H9S
    Public Const P922x_DO_CONVSRC_DACONV As Short = &HAS
    'Trigger Mode
    Public Const P922x_DO_TRGMOD_POST As Short = &H0S
    Public Const P922x_DO_TRGMOD_DELAY As Short = &H1S
    'Trigger Source
    Public Const P922x_DO_TRGSRC_SOFT As Short = &H0S
    ...
    'Trigger Polarity
    Public Const P922x_DO_TrgPositive As Short = &H0S
    Public Const P922x_DO_TrgNegative As Short = &H100S
    'Retrigger
    Public Const P922x_DO_EnReTigger As Short = &H200S
    ' -- Encoder/GPTC Constants -- '
    Public Const P922x_GPTC0 As Short = &H0S
    Public Const P922x_GPTC1 As Short = &H1S
    Public Const P922x_GPTC2 As Short = &H2S
    Public Const P922x_GPTC3 As Short = &H3S
    Public Const P922x_ENCODER0 As Short = &H4S
    Public Const P922x_ENCODER1 As Short = &H5S
    'Encoder Setting Event Mode
    Public Const P922x_EVT_MOD_EPT As Short = &H0S
    'Encoder Setting Event Control
    Public Const P922x_EPT_PULWIDTH_200us As Short = &H0S
    Public Const P922x_EPT_PULWIDTH_2ms As Short = &H1S
    Public Const P922x_EPT_PULWIDTH_20ms As Short = &H2S
    Public Const P922x_EPT_PULWIDTH_200ms As Short = &H3S
    Public Const P922x_EPT_TRGOUT_GPO As Short = &H4S
    Public Const P922x_EPT_TRGOUT_CALLBACK As Short = &H8S
    'Event Type
    Public Const P922x_EVT_TYPE_EPT0 As Short = &H0S
    Public Const P922x_EVT_TYPE_EPT1 As Short = &H1S
    'SSI signal code
    Public Const P922x_SSI_AI_CONV As Short = &H2S
    Public Const P922x_SSI_AI_TRIG As Short = &H20S
    Public Const P922x_SSI_AO_CONV As Short = &H4S
    ...
    'Sampled Clock
    Public Const P7350_IntSampledCLK As Short = &H0S
    Public Const P7350_ExtSampledCLK As Short = &H1S
    'Sampled Clock Edge
    Public Const P7350_SampledCLK_R As Short = &H0S
    Public Const P7350_SampledCLK_F As Short = &H2S
    'Enable Export Sample Clock*/
    Public Const P7350_EnExpSampledCLK As Short = &H4S
    'Trigger Configuration
    Public Const P7350_EnPauseTrig As Short = &H1S
    Public Const P7350_EnSoftTrigOut As Short = &H2S
    'HandShake & Trigger Polarity
    Public Const P7350_DIREQ_POS As Short = &H0S
    Public Const P7350_DIREQ_NEG As Short = &H1S
    Public Const P7350_DIACK_POS As Short = &H0S
    Public Const P7350_DIACK_NEG As Short = &H2S
    Public Const P7350_DITRIG_POS As Short = &H0S
    Public Const P7350_DITRIG_NEG As Short = &H4S
    Public Const P7350_DIStartTrig_POS As Short = &H0S
    Public Const P7350_DIStartTrig_NEG As Short = &H8S
    Public Const P7350_DIPauseTrig_POS As Short = &H0S
    Public Const P7350_DIPauseTrig_NEG As Short = &H10S
    Public Const P7350_DOREQ_POS As Short = &H0S
    Public Const P7350_DOREQ_NEG As Short = &H1S
    Public Const P7350_DOACK_POS As Short = &H0S
    Public Const P7350_DOACK_NEG As Short = &H2S
    Public Const P7350_DOTRIG_POS As Short = &H0S
    Public Const P7350_DOTRIG_NEG As Short = &H4S
    Public Const P7350_DOStartTrig_POS As Short = &H0S
    Public Const P7350_DOStartTrig_NEG As Short = &H8S
    Public Const P7350_DOPauseTrig_POS As Short = &H0S
    ...
    Public Const P7350_DisDDA As Short = &H0S
    Public Const P7350_EnDDA As Short = &H1S
    'Dynamic Delay Adjust Mode
    Public Const P7350_DDA_Lag As Short = &H0S
    Public Const P7350_DDA_Lead As Short = &H2S
    ...
    Public Const P7350_DisDPA As Short = &H0S
    Public Const P7350_EnDPA As Short = &H1S
    ...
    'Sampled Clock
    Public Const P7360_IntSampledCLK As Short = &H0S
    Public Const P7360_ExtSampledCLK As Short = &H1S
    'Sampled Clock Edge
    Public Const P7360_SampledCLK_R As Short = &H0S
    Public Const P7360_SampledCLK_F As Short = &H2S
    'Enable Export Sample Clock*/
    Public Const P7360_EnExpSampledCLK As Short = &H4S
    'Trigger Configuration
    Public Const P7360_EnPauseTrig As Short = &H1S
    Public Const P7360_EnSoftTrigOut As Short = &H2S
    'HandShake & Trigger Polarity
    Public Const P7360_DIREQ_POS As Short = &H0S
    Public Const P7360_DIREQ_NEG As Short = &H1S
    Public Const P7360_DIACK_POS As Short = &H0S
    Public Const P7360_DIACK_NEG As Short = &H2S
    Public Const P7360_DITRIG_POS As Short = &H0S
    Public Const P7360_DITRIG_NEG As Short = &H4S
    Public Const P7360_DIStartTrig_POS As Short = &H0S
    Public Const P7360_DIStartTrig_NEG As Short = &H8S
    Public Const P7360_DIPauseTrig_POS As Short = &H0S
    Public Const P7360_DIPauseTrig_NEG As Short = &H10S
    Public Const P7360_DOREQ_POS As Short = &H0S
    Public Const P7360_DOREQ_NEG As Short = &H1S
    Public Const P7360_DOACK_POS As Short = &H0S
    Public Const P7360_DOACK_NEG As Short = &H2S
    Public Const P7360_DOTRIG_POS As Short = &H0S
    Public Const P7360_DOTRIG_NEG As Short = &H4S
    Public Const P7360_DOStartTrig_POS As Short = &H0S
    Public Const P7360_DOStartTrig_NEG As Short = &H8S
    Public Const P7360_DOPauseTrig_POS As Short = &H0S
    ...
    'Enable Dynamic Delay Adjust
    Public Const P7360_DisDDA As Short = &H0S
    Public Const P7360_EnDDA As Short = &H1S
    'Dynamic Delay Adjust Mode
    Public Const P7360_DDA_Lag As Short = &H0S
    Public Const P7360_DDA_Lead As Short = &H2S
    'Enable Dynamic Phase Adjust
    Public Const P7360_DisDPA As Short = &H0S
    Public Const P7360_EnDPA As Short = &H1S
    'ECLK output type control
    Public Const P7360_ECLKAligned As Short = &H0S
    Public Const P7360_ECLKAlwaysOn As Short = &H1S
    '--------------------------------'
    ...
    'SPI Clock Mode
    Public Const SPI_CLK_L As Short = &H0S
    Public Const SPI_CLK_H As Short = &H1S
    'SPI TX Polarity
    Public Const SPI_TX_POS As Short = &H0S
    Public Const SPI_TX_NEG As Short = &H2S
    'SPI RX Polarity
    Public Const SPI_RX_POS As Short = &H0S
    Public Const SPI_RX_NEG As Short = &H4S
    'SPI Transferred Order
    Public Const SPI_MSB As Short = &H0S
    Public Const SPI_LSB As Short = &H8S
