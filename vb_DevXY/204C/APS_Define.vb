...
Module APS_Define
    ...
    Public Const PRF_CHKERRCNT_LAYER As Short = &H4S '// Set the check error count layer.
    ...
    Public Const TIG_LCMP0_SRC As Short = &H0S
    Public Const TIG_LCMP1_SRC As Short = &H1S
    Public Const TIG_LCMP2_SRC As Short = &H2S
    Public Const TIG_LCMP3_SRC As Short = &H3S
    Public Const TIG_LCMP4_SRC As Short = &H4S
    Public Const TIG_LCMP5_SRC As Short = &H5S
    Public Const TIG_LCMP6_SRC As Short = &H6S
    Public Const TIG_LCMP7_SRC As Short = &H7S
    Public Const TIG_TCMP0_SRC As Short = &H8S
    Public Const TIG_TCMP1_SRC As Short = &H9S
    Public Const TIG_TCMP2_SRC As Short = &HAS
    Public Const TIG_TCMP3_SRC As Short = &HBS
    Public Const TIG_TCMP4_SRC As Short = &HCS
    Public Const TIG_TCMP5_SRC As Short = &HDS
    Public Const TIG_TCMP6_SRC As Short = &HES
    Public Const TIG_TCMP7_SRC As Short = &HFS
